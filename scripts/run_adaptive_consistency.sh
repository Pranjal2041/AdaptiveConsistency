...
python scripts/run_eval.py --dataset gsm --answer_type float --max_gens 40 --temperature 0.7 --prompt_type code --prompt_file math_prompts --stop_criteria $stop_criteria --stop_criteria_thresh $stop_criteria_thresh
